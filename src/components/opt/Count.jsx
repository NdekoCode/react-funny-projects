  ...
  return (
    <div className="mx-auto max-w-7xl">
      <div className="flex justify-center flex-col items-center">
        <div className="p-3 shadow border-t border-l flex flex-col justify-center items-center border-gray-100 min-h-[100px] h-max min-w-[100px] w-max rounded-2xl mb-3">
          <h1 className="text-3xl mb-3 font-bold text-gray-700">
            {state.count}
          </h1>
        </div>
        <div className="flex">
